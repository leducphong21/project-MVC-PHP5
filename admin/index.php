	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li><a href="index.php?action=student">Sinh viên</a></li>
				<li><a href="index.php?action=teacher">Giáo viên</a></li>
				<li><a href="index.php?action=course">Khóa học</a></li>
				<li><a href="index.php?action=question_course">Câu hỏi</a></li>
